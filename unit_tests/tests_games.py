...
def test_get_move_speak():
    for language in supported_languages:
        for move in moves:
            ...
            assert games.get_move_speak(move['input'], language) == move['expected_output_move_speak'][language] + '<break time="0.5s"/>'
